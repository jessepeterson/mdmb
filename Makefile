...
release:
	GOOS=darwin GOARCH=amd64 go build -o mdmb ./cmd/mdmb
	zip mdmb-darwin-amd64-${VERSION}.zip mdmb
	GOOS=linux GOARCH=amd64 go build -o mdmb ./cmd/mdmb
	zip mdmb-linux-amd64-${VERSION}.zip mdmb
	GOOS=windows GOARCH=amd64 go build -o mdmb.exe ./cmd/mdmb
